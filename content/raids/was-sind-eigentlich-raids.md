...
Desweiterem benötigt ihr Quellen, die <tooltip text="Schnelligkeit" title="Fertigkeiten und Aktionen sind um 50% beschleunigt." class="boon quickness"> für eure Gruppe aufrecht halten können. Dies Kann z.B. der bereits erwähnte Heal Firebrand, oder auch eine Variante des Condi Firebrands, der Quickness Firebrand (qFB). Beide Firebrand Build können <tooltip text="Schnelligkeit" title="Fertigkeiten und Aktionen sind um 50% beschleunigt." class="boon quickness"> allerdings nur für 5 Personen aufrecht halten! Eine weitere Möglichkeit <tooltip text="Schnelligkeit" title="Fertigkeiten und Aktionen sind um 50% beschleunigt." class="boon quickness"> zu verteilen ist ein Quickness Chronomant. Dieser ist eine Variantion des Power Chronos und kann <tooltip text="Schnelligkeit" title="Fertigkeiten und Aktionen sind um 50% beschleunigt." class="boon quickness"> für 5 Spieler\*innen aufrecht halten.

Bei einigen Bossen wird ein Tank benötigt. Der Tank hat die aufgabe, dafür zu sorgen, wann und wie sich ein Boss bewegt, sowie durch sein positioning die Gruppe vor Schaden zu bewahren. Einige Bosse haben eine Zähigkeits-basierte Tankmechanik, andere wählen einen zufälligen Tank aus. teilweise wird man auch durch das interagieren mit speziellen Dingen zum Tank.
Da Tanks meistens mehr schaden bekommen, sollte der Tank ein Build wählen, mit dem er Überleben kann. Hierbei solltet ihr aber trotzdem versuchen eure Gruppe so gut es geht zu unterstützen. Oftmals werden Chrono Tanks benutzt. Diese haben durch eine Menge an Blocks gut die Möglichkeit zu überleben und können gleichzeitig auch <tooltip text="Schnelligkeit" title="Fertigkeiten und Aktionen sind um 50% beschleunigt." class="boon quickness"> verteilen. 
Auch eine Möglichkeit ist es, einen Heiler Tanken zu lassen.
            
Eine ausführliche Zusammenfassung über Teamaufstellungen und wer genau was, bzw. wie abdecken kann, findet ihr in unseren Kommandeur-Guide!
